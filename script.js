...
let arrayPalabras =["CASCO", "GUANTES", "CALZADO", "CHALECO", "RODILLERAS"];
//Arreglo que contiene las ayudas de cada palabra
let ayudas = [
    "Protege el craneo de posibles impactos.",
    "Cubren la mano completa.",
    "Cubren el tobillo de posibles lesiones.",
    "Su función es proteger toda la parte abdominal amortiguando golpes.",
    "evita el contacto directo de las ____ con el suelo de forma que se minimicen las lesiones.",
...
function cargarNuevaPalabra(){
    ...
    if(cantPalabrasJugadas>6){
        ...
        arrayPalabras =["CASCO", "GUANTES", "CALZADO", "CHALECO", "RODILLERAS"];
        ayudas = [
            "Protege el craneo de posibles impactos.",
            "Cubren la mano completa.",
            "Cubren el tobillo de posibles lesiones.",
